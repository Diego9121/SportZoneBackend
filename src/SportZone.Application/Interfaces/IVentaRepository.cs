...
public interface IVentaRepository : IRepository<Venta>
{
    ...
    // Crea Venta + detalle + pagos y DECREMENTA el stock de cada variante, todo en una transacción
    Task<Venta> CrearConDetalleAsync(Venta venta, List<VentaDetalle> detalles, List<VentaPago> pagos);
